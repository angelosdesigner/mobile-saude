...
const prazosCards = [
  {
    tag: 'alto volume de nips',
    number: 7,
    title: 'Reembolsos',
    sub: ['Mais próximo do vencimento: 4 dias', 'Prazo médio: 2 dias'],
  },
  {
    tag: 'Risco de escalonamento',
    number: 3,
    title: 'Ouvidoria e reanálise',
    sub: ['Mais urgente vence em: 1 dia', 'Prazo médio: 6h'],
  },
  {
    tag: 'Maior criticidade e multas',
    number: 2,
    title: 'Alta complexidade e cirurgia',
    sub: ['Mais urgente vence em: 2 dias', 'Prazo médio: 1 dia'],
  },
  {
    tag: 'Menor prazo regulatório',
    number: 4,
    title: 'Negativas por escrito e exames',
    sub: ['Mais urgente vence em: 3h', 'Prazo médio: 1h'],
  },
]
...
const encColumns = [
  {
    ...
    rows: [
      {
        label: 'Pendências com beneficiário: 6',
        meta: [
          'Próximo SLA Regulatório: 14 min',
          'Próximo SLA Interno: 14 min',
          'Última interação: 1d',
        ],
      },
      {
        label: 'Pendências com área interna: 4',
        meta: [
          'Próximo SLA Regulatório: 14 min',
          'Próximo SLA Interno: 14 min',
          'Última interação: 30min',
        ],
      },
    ],
  },
...
const kpis = [
  { tag: 'SLA Regulatório', value: '96%', label: 'Resolução dentro do SLA Regulatório', note: '' },
  {
    ...
    note: 'Alta reabertura aumenta risco jurídico futuro.',
  },
      ...
      <section class="rounded-xl border border-ms-danger/20 bg-ms-danger/5 p-5">
        <header class="mb-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-ms-text-regular">
              Situações com SLA Regulatório ultrapassado ou infração em tempo real.
            </p>
          </div>
        </header>
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          >
            ...
            <h3 class="mt-2 text-2xl font-bold text-ms-text-primary">{{ card.title }}</h3>
            <ul class="mt-3 flex flex-wrap gap-x-6 gap-y-1">
              <li v-for="i in card.items" :key="i" class="text-sm font-medium text-ms-text-regular">
                {{ i }}
              </li>
            </ul>
      ...
      <section class="rounded-xl border border-ms-warning/20 bg-ms-warning/5 p-5">
        <header class="mb-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-ms-text-regular">
              Demandas próximas do vencimento do SLA Regulatório.
            </p>
          </div>
        </header>
      ...
      <section class="rounded-xl border border-ms-primary/20 bg-ms-primary-light p-5">
        <header class="mb-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-ms-text-regular">
              Demandas dentro do SLA Regulatório com monitoramento preventivo.
            </p>
          </div>
        </header>
        ...
        <div class="grid gap-4 lg:grid-cols-2">
          ...
          >
            ...
            <div
              ...
              :key="row.label"
              class="mt-3 border-t border-ms-border-light pt-3 first:border-t-0 first:pt-0"
            >
        ...
        <div class="mt-4 grid gap-4 lg:grid-cols-2">
          ...
          <el-card shadow="always" class="!border-ms-primary/20">
            ...
            <ul class="mt-3 space-y-1">
              <li
                v-for="l in slaInterno.lines"
                :key="l"
                class="text-sm font-medium text-ms-text-regular"
              >
                {{ l }}
              </li>
            </ul>

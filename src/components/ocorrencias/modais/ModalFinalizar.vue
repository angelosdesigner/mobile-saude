...
const motivos = ['Resolvido', 'Sem retorno do beneficiário', 'Duplicado', 'Encaminhado para outro setor', 'Improcedente']
...
<template>
  ...
  >
    <template #header>
      <h3 class="text-xl font-bold text-[#303133]">Finalizar atendimento</h3>
    </template>

    <div class="space-y-4">
      <div>
        <label class="mb-1.5 block text-[#303133]">Motivo da finalização</label>
    ...
    <template #footer>
      ...
      <el-button type="primary" :disabled="!motivo" @click="finalizar">Finalizar atendimento</el-button>
    </template>
  </el-dialog>
</template>
